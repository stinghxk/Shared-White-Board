...
public class Message implements Serializable
{
	...
	public static final int DRAW_UPDATE = 13;
	...
	public Message(String user, int typeValue, String contentValue)
	{
	...
	public boolean equals(Object obj)
	{
		...
		return getUsername().equals(message.getUsername())
	...
	public String toString()
	{
		...
		return "<Message>User:" + getUsername()  + "\tType:" + tp;
	}
}
